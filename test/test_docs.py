...
def process_file():
    torch_docs_fn = 'torch/_torch_docs.py'  # os.path.join(os.path.dirname(torch.__file__),'_torch_docs.py')
...
# call with "--file" to produce a regenerated torch/_torch_docs.py
